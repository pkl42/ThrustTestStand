...
const float VOLTAGE_SENSOR_MAX = 35.f;  // the resistor dividor would allow 36,3 V
const float CURRENT_SENSOR_MAX = 48.f;  // datasheet allows 50A
const float THRUST_SENSOR_MAX = 5000.f; // 5kg
const float RPM_SENSOR_MAX = 30000;
// const float TORQUE_SENSOR_MAX
const float TEMPERATURE_SENSOR_MAX = 120.; //
